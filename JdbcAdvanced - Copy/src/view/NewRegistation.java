   ...
   /**
    ...
    public void updateTableDep(){
        ...
        try{
            ...
            DefaultTableModel record = (DefaultTableModel)departmentTable.getModel();
            ...
            while(rs.next()){
                ...
                for(i=1; i<=q;i++){
                    columnData.add(rs.getString("depId"));
                    columnData.add(rs.getString("depName"));
                }
    ...
    public void updateTableStaff(){
        ...
        try {
            ...
            q = stData.getColumnCount();
            DefaultTableModel record = (DefaultTableModel) staffTable.getModel();
            record.setRowCount(0);
