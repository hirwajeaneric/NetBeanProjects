...
public class operationForm extends javax.swing.JInternalFrame {
    ...
    public void updateTableBookTransaction(){
        ...
        List<BookTransaction> all = new BookTransactionDao().findAll();
        for (BookTransaction bookTransaction : all) {
            model.insertRow(model.getRowCount(), new Object[]{
                
                //bookTransactionTable.ge(),
                //bookTransactionTable.getFirstName(),
                //bookTransactionTable.getLastName(),
                //bookTransactionTable.getPhoneNUmber(),
                });
        }
    }
